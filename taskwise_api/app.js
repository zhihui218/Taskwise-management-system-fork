...
app.use('/project', isAuthorized, require('./routes/project.route'));
app.use('/attachment', isAuthorized, require('./routes/attachment.route'));
app.use('/task', isAuthorized, require('./routes/task.route'));
app.use('/user', require('./routes/user.route'));
app.use('/ticket', isAuthorized, require('./routes/ticket.route'));
app.use('/notification', isAuthorized, require('./routes/notification.route'));
app.use('/dashboard', isAuthorized, require('./routes/dashboard.route'));
app.use('/chat', isAuthorized, require('./routes/chat.route'));
